...
import { IoIosRefresh, IoLogoApple, IoMdHome } from "react-icons/io";
    ...
    <div>
                ...
                <div className="container mx-auto px-2 sm:px-6 lg:px-2">
                  <div className="relative flex h-20 items-center justify-between">
                    ...
                    {showModal2 ? (
                      <div>
                        <div className="justify-center items-center  flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                          <div className="relative w-auto my-6 mx-auto max-w-6xl px-6 ">
                            {/*content*/}
                    ...
                    <div className="absolute inset-y-0 right-0 lg:flex grid items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                      <button
                        type="button"
                        className="relative ml-4 rounded-md bg-[#F84464] py-2 px-6 md:px-4 text-white duration-200 "
                              ...
                              <div className="border-0 rounded-lg shadow-lg relative  h-96 flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="my-auto">
                                  ...
                                  <div className="grid grid-cols-2 text-center mb-2">
                                    <p className="mx-5 p-2   rounded-md">
                                      01:00
                                    </p>
                                  ...
                                  <div className="grid grid-cols-2">
                                    ...
                                    <button className="bg-themecolor1 mx-5 p-2 text-white  rounded-md">
                                      Verify OTP
                                    </button>
                                  </div>
                                </div>
            ...
            {({ open }) => (
              <div>
                <div className="mx-auto container px-2 sm:px-6 lg:px-2">
                  <div className="relative h-[50px] items-center justify-between w-[10%] md:w-full">
      ...
      <div className="bottomNavbar lg:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
          {bottomNavdata.map(({ label, icons, link, val, id }) => {
            return (
